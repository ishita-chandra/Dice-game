...
if(randomNumber2===1){
c.setAttribute("src","images/dice1.png");
}
else if(randomNumber2===2){
c.setAttribute("src","images/dice2.png");
}
else if(randomNumber2===3){
c.setAttribute("src","images/dice3.png");
}
else if(randomNumber2===4){
c.setAttribute("src","images/dice4.png");
}
else if(randomNumber2===5){
c.setAttribute("src","images/dice5.png");
}
else {
  c.setAttribute("src","images/dice6.png");
}
